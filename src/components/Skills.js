...
import {SiFlutter, SiStrapi, SiJavascript,SiTailwindcss,SiCplusplus, SiC, SiNodedotjs,SiGithub} from 'react-icons/si';
    ...
    <div className='max-w-7xl mx-auto  py-[6rem]' id='skill'>
        ...
        <div className='flex m-5 flex-wrap justify-center pt-2'>
             ...
             <div className='flex flex-col md:w-[15%] md:h-[20%]  p-2 m-3 overflow-hidden bg-white shadow-2xl rounded-xl sm:w-52  transform transition duration-500 hover:scale-110'>
              ...
              <p className='mt-6 text-xl sm:text-2xl text-semibold text-center'>Javascript</p>
            </div>
             <div className='flex flex-col md:w-[15%] md:h-[20%] p-2 m-3 overflow-hidden bg-white shadow-2xl rounded-xl sm:w-52  transform transition duration-500 hover:scale-110'>
             ...
             <div className='flex flex-col md:w-[15%] md:h-[20%]  p-2 m-3 overflow-hidden bg-white shadow-2xl rounded-xl sm:w-52  transform transition duration-500 hover:scale-110'>
              ...
              <p className='mt-6 text-xl sm:text-2xl text-semibold text-center'>ReactJS</p>
            </div>
             <div className='flex flex-col md:w-[15%] md:h-[20%]  p-2 m-3 overflow-hidden bg-white shadow-2xl rounded-xl sm:w-52  transform transition duration-500 hover:scale-110'>
              <SiTailwindcss color='#00c0a3' className='mx-auto text-2xl sm:text-4xl'/>
              <p className='mt-6 text-xl sm:text-2xl text-semibold text-center'>Tailwind</p>
              ...
              <p className='mt-6 text-xl sm:text-2xl text-semibold text-center'>  <span>  {' '}    CSS {' '} </span> </p>
            </div>
             <div className='flex flex-col md:w-[15%] md:h-[20%]  p-2 m-3 overflow-hidden bg-white shadow-2xl rounded-xl sm:w-52  transform transition duration-500 hover:scale-110'>
              < SiNodedotjs color='#2196f3' className='mx-auto text-2xl sm:text-4xl'/>
              <p className='mt-6 text-xl sm:text-2xl text-semibold text-center'>NodeJS</p>
            </div>
             <div className='flex flex-col md:w-[15%] md:h-[20%]  p-2 m-3 overflow-hidden bg-white shadow-2xl rounded-xl sm:w-52  transform transition duration-500 hover:scale-110'>
              <SiGithub color='#2196f3' className='mx-auto text-2xl sm:text-4xl'/>
              <p className='mt-6 text-xl sm:text-2xl text-semibold text-center'>Github</p>
            </div>
                        <div className='flex flex-col md:w-[15%] md:h-[20%]  p-2 m-3 overflow-hidden bg-white shadow-2xl rounded-xl sm:w-52  transform transition duration-500 hover:scale-110'>
             ...
             <div className='flex flex-col  p-2 m-3 md:w-[15%] md:h-[20%]    overflow-hidden bg-white shadow-2xl rounded-xl  transform transition duration-500 hover:scale-110'>
              ...
              <p className='mt-6 text-xl sm:text-2xl text-semibold text-center'>C</p>
            </div>
             <div className='flex flex-col md:w-[15%] md:h-[20%]  p-2 m-3 overflow-hidden bg-white shadow-2xl rounded-xl sm:w-52   transform transition duration-500 hover:scale-110'>
