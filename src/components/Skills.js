  ...
  return (
    <div className='max-w-7xl mx-auto  py-[6rem]' id='skill'>
        ...
        <div className='flex m-5 flex-wrap justify-center pt-2'>
            <div className='flex flex-col w-[10%] h-[10%] p-5 m-3 overflow-hidden bg-white shadow-2xl rounded-xl sm:w-52  transform transition duration-500 hover:scale-110'>
             ...
             <div className='flex flex-col w-[10%] h-[10%] p-5 m-3 overflow-hidden bg-white shadow-2xl rounded-xl sm:w-52  transform transition duration-500 hover:scale-110'>
              ...
              <p className='mt-6 text-xl sm:text-2xl text-semibold text-center'>Flutter</p>
            </div> <div className='flex flex-col w-[10%] h-[10%] p-5 m-3 overflow-hidden bg-white shadow-2xl rounded-xl sm:w-52  transform transition duration-500 hover:scale-110'>
